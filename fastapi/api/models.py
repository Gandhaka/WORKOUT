...
class Workout(Base):
    ...
    routines = relationship('Routines',secondary = workout_routine_association, back_populates='workouts')
...
Workout.routines = relationship('Routines',secondary=workout_routine_association,back_populates='workouts')
